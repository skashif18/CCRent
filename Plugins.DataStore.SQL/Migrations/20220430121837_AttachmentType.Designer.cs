...
namespace Plugins.DataStore.SQL.Migrations
{
    ...
    [Migration("20220430121837_AttachmentType")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoreBusiness.Master.SrvServiceAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("FileTypeNavigationId")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ServiceTypeAttachmentId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FileTypeNavigationId");

                    b.HasIndex("ServiceId");

                    b.HasIndex("ServiceTypeAttachmentId");

                    b.ToTable("SrvServiceAttachments");
                });
            ...
            modelBuilder.Entity("CoreBusiness.Master.SrvServiceSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CoreBusiness.Master.SrvServiceTypeAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SrvServiceTypeAttachments");
                });
            ...
            modelBuilder.Entity("CoreBusiness.Master.SrvServiceAttachment", b =>
                {
                    b.HasOne("CoreBusiness.Master.SrvFileType", "FileTypeNavigation")
                        .WithMany()
                        .HasForeignKey("FileTypeNavigationId");
                    ...
                    b.HasOne("CoreBusiness.Master.SrvServiceTypeAttachment", "ServiceTypeAttachment")
                        .WithMany("SrvServiceAttachments")
                        .HasForeignKey("ServiceTypeAttachmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("ServiceTypeAttachment");
                });
            ...
            modelBuilder.Entity("CoreBusiness.Master.SrvServiceTypeAttachment", b =>
                {
                    b.Navigation("SrvServiceAttachments");
                });
